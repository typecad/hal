...
|---|---|---|---|---|---|
| framework-arduino (canonical) | 12/18 | 4 | 2 | arduino-cli (prepare ✓ compile ✓ upload ✓ monitor ✓) | 2026-07-25 |
| framework-avr | 13/18 | 3 | 2 | arduino-cli (reexported from @typecad/framework-arduino) (prepare ✓ compile ✓ upload ✓ monitor ✓) | 2026-07-25 |
| framework-esp32 | 15/18 | 3 | 0 | idf.py (prepare ✓ compile ✓ upload ✓ monitor ✓) | 2026-07-25 |
