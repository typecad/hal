...
void setup()
{
  __tc_ble_set_tx_power(9);
  {
    __tc_ble_set_name("Thermostat");
    __tc_ble_add_char(0, "2A6E", "int16", 1, 1);
    __tc_ble.on_read[0] = &main_isr_0;
  }
  {
    __tc_ble_set_name("Thermostat");
    __tc_ble_add_char(1, "2A1F", "int16", 3, 1);
    __tc_ble.on_read[1] = &main_isr_2;
    __tc_ble.on_write[1] = &main_isr_1;
  }
  {
    __tc_ble_set_name("Thermostat");
    __tc_ble_server_begin("Thermostat");
