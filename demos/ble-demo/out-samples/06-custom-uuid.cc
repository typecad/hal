...
{
  {
    __tc_ble_set_name("CustomDevice");
    __tc_ble_add_char(0, "a1b2c3d4-0000-1000-8000-00805f9b34fb", "uint8", 1, 1);
    __tc_ble.on_read[0] = &main_isr_1;
    __tc_ble_add_char(0, "a1b2c3d4-0001-1000-8000-00805f9b34fb", "utf8", 1, 1);
    __tc_ble.on_read[1] = &main_isr_0;
  }
  {
    __tc_ble_set_name("CustomDevice");
    __tc_ble_server_begin("CustomDevice");
