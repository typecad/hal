...
async function performAnalysis() {
    ...
    try {
        ...
        status.tooltip = `TypeCAD Intel: ${err.message}\nClick to retry after installing.`;
        return;
    }
    let result;
    try {
