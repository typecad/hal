...
MCU definition package for the **Raspberry Pi RP2040** (dual Arm Cortex-M0+).
...
framework. Board packages (e.g. [`@typecad/board-rp2040`](../board-rp2040))
...
- [`@typecad/board-rp2040`](../board-rp2040) — board package using this MCU
