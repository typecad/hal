// ---------------------------------------------------------------------------
// @typecode/board-native-atmega328p — Typed pin exports
//
...
// transpiler replaces them with native AVR register operations during code-gen.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// PWM pins (also digital-capable)
// ---------------------------------------------------------------------------

export const D3:  IPWMPin = createPWMPin(3, 3);    // also INT1, OC2B
export const D5:  IPWMPin = createPWMPin(5, 5);    // OC0B
export const D6:  IPWMPin = createPWMPin(6, 6);    // OC0A
export const D9:  IPWMPin = createPWMPin(9, 9);    // OC1A
export const D10: IPWMPin = createPWMPin(10, 10);  // OC1B
export const D11: IPWMPin = createPWMPin(11, 11);  // OC2A

// ---------------------------------------------------------------------------
// Analog input pins (A0-A5, also digital-capable)
// ---------------------------------------------------------------------------

export const A0: IAnalogInput = createAnalogPin(14, 14);  // ADC0
export const A1: IAnalogInput = createAnalogPin(15, 15);  // ADC1
export const A2: IAnalogInput = createAnalogPin(16, 16);  // ADC2
export const A3: IAnalogInput = createAnalogPin(17, 17);  // ADC3
export const A4: IAnalogInput = createAnalogPin(18, 18);  // ADC4, SDA
export const A5: IAnalogInput = createAnalogPin(19, 19);  // ADC5, SCL
