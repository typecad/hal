// ---------------------------------------------------------------------------
// @typecad/mcu-rp2350 — Hardware peripheral descriptions
// Dual-core Cortex-M33 @ 150 MHz. 2× I2C, 2× SPI, 2× UART, 1× ADC (8ch, 12-bit),
// 8× PWM slices, 4× timers. No wireless. No DAC.
// ---------------------------------------------------------------------------
...
export const PWM_CAPABILITIES: PWMDefinition = {
  channels: 8, resolution: 16, maxFrequency: 75_000_000,
} as const;
