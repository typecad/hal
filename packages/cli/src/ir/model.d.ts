...
export type StatementIR = CallExpressionIR | VariableDeclarationIR | AssignmentIR | UpdateIR | ReturnIR | WhileIR | DoWhileIR | IfIR | ForIR | ForOfIR | ForInIR | BreakIR | ContinueIR | SwitchIR | TryIR | ThrowIR;
