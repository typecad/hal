...
Key files:
  ...
  - packages/cli/src/config-loader.ts      : typehal.config.ts loading and board/package config
...
2. Config loading and effective option resolution
   - `loadTypehalConfig()` from `packages/cli/src/config-loader.ts` reads `typehal.config.ts`.
 ...
 * 
 * @param frameworkPackage The framework package name (e.g., '@typehal/framework-avr')
