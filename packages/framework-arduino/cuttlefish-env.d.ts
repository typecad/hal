// ---------------------------------------------------------------------------
// TypeCAD-env.d.ts — Virtual module declaration for '@TypeCAD'
//
// Auto-generated by the TypeCAD transpiler. Do not edit manually.
// To change the board, update TypeCAD.config.ts and re-run the transpiler.
//
