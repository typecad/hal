// ---------------------------------------------------------------------------
// @typehal/framework-arduino — Arduino Library Declaration Generator
//
...
function generateExportDeclaration(
  ...
  lines.push(" *");
  lines.push(" * Auto-generated by TypeHAL from Arduino library C++ headers.");
  lines.push(" * Arduino peripheral types (TwoWire, HardwareSerial, etc.) are mapped to TypeHAL equivalents.");
  lines.push(" *");
  ...
  lines.push(" *");
  lines.push(" * To regenerate: delete this file and re-run typehal transpile.");
  lines.push(" */");
  lines.push("");
...
export function generateUsageDocumentation(
  ...
  lines.push(`# ${libraryName} - TypeHAL Usage Guide`);
  lines.push("");
  ...
  lines.push("## Overview");
  lines.push("");
  lines.push(`This library was auto-discovered from your Arduino installation and TypeHAL`);
    ...
    for (const cppClass of parsed.classes) {
      ...
      if (cppClass.methods.length > 0) {
        ...
        if (peripheralTypes.size > 0) {
          lines.push(`import { ${[...peripheralTypes].join(", ")} } from '@typehal';`);
        }
        lines.push("");
  ...
  lines.push("");
  lines.push("TypeHAL automatically maps Arduino C++ types to TypeScript equivalents:");
  lines.push("");
  lines.push("| Arduino C++ | TypeHAL TypeScript |");
  lines.push("|-------------|---------------------|");
  ...
  lines.push("- Add JSDoc documentation");
  lines.push("");
  lines.push("To regenerate: delete the file and re-run TypeHAL transpile.");
  lines.push("");
