  ...
  hal: {
    ...
    timing: {
      ...
      ops: {
        ...
        'timing.set_interval': 'probe-inconclusive',
        'timing.set_timeout': 'probe-inconclusive',
        'timing.clear_interval': 'probe-inconclusive',
        'timing.clear_timeout': 'probe-inconclusive',
      },
    },
    power: {
      supported: true,
