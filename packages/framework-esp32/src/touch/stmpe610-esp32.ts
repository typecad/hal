...
export function esp32Stmpe610TouchAdapter(touch: TouchProfile): TouchAdapterCodegen {
  ...
  return {
    ...
    functions: [
      ...
      `  __esp32_touch_cached_x = static_cast<int16_t>((static_cast<uint16_t>(data[0]) << 4) | (data[1] >> 4));`,
      `  __esp32_touch_cached_y = static_cast<int16_t>((static_cast<uint16_t>(data[1] & 0x0F) << 8) | data[2]);`,
      `  __esp32_touch_cached_z = static_cast<int16_t>(data[3]);`,
