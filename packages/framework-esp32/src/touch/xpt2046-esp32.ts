...
export function esp32Xpt2046TouchAdapter(touch: TouchProfile): TouchAdapterCodegen {
  ...
  return {
    ...
    functions: [
      ...
      `  int16_t z1 = (int16_t)(__esp32_touch_xfer16(XPT_CMD_Z2) >> 3);  // Z1 result + send Z2`,
      `  int16_t z2 = (int16_t)(__esp32_touch_xfer16(XPT_CMD_X) >> 3);   // Z2 result + send X`,
      ...
      `  int16_t y0 = (int16_t)(__esp32_touch_xfer16(XPT_CMD_Y) >> 3);   // Y sample 0`,
      `  int16_t x0 = (int16_t)(__esp32_touch_xfer16(XPT_CMD_X) >> 3);   // X sample 0`,
      `  int16_t y1 = (int16_t)(__esp32_touch_xfer16(XPT_CMD_Y) >> 3);   // Y sample 1`,
      `  int16_t x1 = (int16_t)(__esp32_touch_xfer16(XPT_CMD_X) >> 3);   // X sample 1`,
      `  int16_t y2 = (int16_t)(__esp32_touch_xfer16(XPT_CMD_Y_PWDN) >> 3); // Y sample 2 (powers down)`,
