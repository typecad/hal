...
export function esp32Gt911TouchAdapter(touch: TouchProfile): TouchAdapterCodegen {
  ...
  return {
    ...
    functions: [
      ...
      `  uint8_t regbuf[2] = { static_cast<uint8_t>(reg & 0xFF), static_cast<uint8_t>(reg >> 8) };`,
      ...
      `  uint8_t buf[3] = { static_cast<uint8_t>(reg & 0xFF), static_cast<uint8_t>(reg >> 8), val };`,
      ...
      `  __esp32_touch_cached_x = static_cast<int16_t>((static_cast<uint16_t>(data[1] & 0x0F) << 8) | data[2]);`,
      `  __esp32_touch_cached_y = static_cast<int16_t>((static_cast<uint16_t>(data[3] & 0x0F) << 8) | data[4]);`,
