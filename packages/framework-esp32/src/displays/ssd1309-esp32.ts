...
export const esp32Ssd1309Adapter: DisplayAdapterGenerator = (display) => {
  ...
  return {
    ...
    functions: [
      ...
      `  c->fillRect(x, y, ww, hh, static_cast<uint16_t>(color));`,
      `}`,
      ``,
      ...
      `  }`,
      `}`,
      `static inline void display_targetFillRect(CuttlefishDisplayTarget* t, int16_t x, int16_t y, int16_t ww, int16_t hh, UI_COLOR_T color) { t->fillRect(x, y, ww, hh, ssd_mono(static_cast<uint16_t>(color))); }`,
      `static inline void display_targetDrawFastHLine(CuttlefishDisplayTarget* t, int16_t x, int16_t y, int16_t ww, UI_COLOR_T color) { t->drawFastHLine(x, y, ww, ssd_mono(static_cast<uint16_t>(color))); }`,
      `static inline void display_targetDrawFastVLine(CuttlefishDisplayTarget* t, int16_t x, int16_t y, int16_t hh, UI_COLOR_T color) { t->drawFastVLine(x, y, hh, ssd_mono(static_cast<uint16_t>(color))); }`,
      `static inline void display_targetFillRoundRect(CuttlefishDisplayTarget* t, int16_t x, int16_t y, int16_t ww, int16_t hh, int16_t r, UI_COLOR_T color) { t->fillRoundRect(x, y, ww, hh, r, ssd_mono(static_cast<uint16_t>(color))); }`,
      `static inline void display_targetDrawRect(CuttlefishDisplayTarget* t, int16_t x, int16_t y, int16_t ww, int16_t hh, UI_COLOR_T color) { t->drawRect(x, y, ww, hh, ssd_mono(static_cast<uint16_t>(color))); }`,
      `static inline void display_targetDrawRoundRect(CuttlefishDisplayTarget* t, int16_t x, int16_t y, int16_t ww, int16_t hh, int16_t r, UI_COLOR_T color) { t->drawRoundRect(x, y, ww, hh, r, ssd_mono(static_cast<uint16_t>(color))); }`,
