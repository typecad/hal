...
import { ZEPHYR_DISPLAY_PROFILES, panelControllerFor, transportFor, synthesizeZephyrProfile, displayFactsLine } from "./profiles.js";
...
export const zephyrDisplayAdapterGenerator: DisplayAdapterGenerator = (display) => {
  ...
  if (transportFor(profile) === 'zephyr-display') {
    return zephyrDisplayApiAdapter(profile);
  }
