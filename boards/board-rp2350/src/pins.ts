...
// Dx aliases (GP0-GP22 + GP26-GP28, mirroring the Pico header; GP23-GP25 and
// GP29 are board-internal and omitted, and GPIO30+ don't exist on the RP2350A)
...
// Ax aliases (ADC channels — GP26-GP28 = ADC0-ADC2; ADC3 = GP29 is the
// board-internal VSYS monitor)
...
// USB CDC serial over the USB-C connector (the RP2350 USBD peripheral's
