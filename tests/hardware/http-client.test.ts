...
// SAN must include your LAN IP (see tests/hardware/certs/README.md to regenerate
// if your IP differs).
...
// concatenation or an imported const would land in setup()-local scope (or a
// separate TU) where the per-test functions can't see it. Keep in sync with
// tests/hardware/certs/ca.crt — see that README to regenerate.
