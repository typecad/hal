...
//
// The inverse of tests/hardware/start-server.ts: there the host runs a server
...
// redist prerequisite are in tests/hardware/README.md.
...
function fail(msg: string): never {
  console.error(`\n  ERROR: ${msg}`);
  console.error('  See tests/hardware/README.md (BLE section) for setup steps.\n');
  process.exit(1);
}
