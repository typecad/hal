...
// uses (@typecad/cuttlefish/build-ir-state → dist), NOT from src. Both paths
// create separate globalDefaultContext maps; using src would make test writes
// invisible to the engine's reads. The dist must be rebuilt before running.
