...
// @typecad/hal/testing user-facing program. Kept here as the preprocessing fixture
// so the smoke test does not depend on the removed Arduino-era examples dir.
const exampleSource = `// ---------------------------------------------------------------------------
// Example: Hardware test file for @typecad/hal/testing
//
...
describe('example test preprocessing', () => {
  it('preprocesses the example file correctly', () => {
    ...
    expect(result).toContain("import { A0, A1 } from '@typecad/hal'");
