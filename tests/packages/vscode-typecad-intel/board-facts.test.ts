// ---------------------------------------------------------------------------
// board-facts.test.ts — the pure parser/resolver behind TypeCAD Intel's
// variable hovers. The module under test imports no 'vscode', so the
// monorepo suite exercises it directly; the provider glue in extension.ts
// is a thin shell over these two functions.
// ---------------------------------------------------------------------------
...
import {
  ...
  scanDecorations,
  isCodePosition,
} from '../../../packages/vscode-typecad-intel/src/board-facts';
