...
import { PolyfillGenerator, generatePolyfills } from "../../../packages/transpiler/src/polyfill/generator";
import { getArchitectureCapabilities, ARCHITECTURE_CAPABILITIES } from "../../../packages/transpiler/src/polyfill/template-types";
