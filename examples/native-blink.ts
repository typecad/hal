...
import { D13, D2, A0, D9, LOW } from '@typecode/board-native-atmega328p';

// Setup function
export function setup(): void {
  // Configure pins
  D13.config.output.initial(LOW);    // LED pin
  D9.config.output.initial(LOW);     // PWM pin
  D2.config.input.float();           // Digital input
}
